...
export const EcommerItems = (): JSX.Element => {
  ...
  if (eCommerceProducts == null) {
    return (
    <div className='grid place-items-center' style={{ height: 'calc(100vh - 80px - 104px' }}>
      <div className='relative w-[335px] h-80 p-5 bg-inherit grid gap-y-5 rounded-lg place-items-center'>
